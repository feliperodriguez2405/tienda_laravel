...
<div class="container">
    <h1 class="mb-4 text-center fw-bold">Productos Disponibles</h1>
                ...
                <div class="product-card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.cart.add', $producto) }}" method="POST" class="d-flex align-items-center">
                            ...
                            <button type="submit" class="btn btn-outline-success" aria-label="Añadir {{ $producto->nombre }} al carrito">
